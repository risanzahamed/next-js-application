                ...
                <div className="relative bg-white  sm:pt-16 lg:py-36 xl:py-48">
                    ...
                    <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-[1400px]">
                        ...
                        <div className="max-w-lg lg:pt-20 lg:pb-20 mx-auto text-center lg:mx-0 lg:max-w-[1000px]  lg:text-left">
                            ...
                            <span className="font-bold lg:text-yellow-400">Share your  love to </span> make someone’s life better
                            ...
                            <div className="mt-8 sm:mt-12">
                                <a className="btn border-0 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300 text-black hover:text-white hover:bg-[#001C42] bg-[#FFCC00]">Donate Now</a>
                            </div>
                        </div>
